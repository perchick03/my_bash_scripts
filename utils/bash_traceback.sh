...
# foo
#
# The error from this unkown command will look like this:
#
#   ./test/test_scripts.sh: line 42: unknown_command: command not found
#   Error in ./test/test_scripts.sh:42 ('unknown_command' exited with status 127)
#   Traceback of ./test/test_scripts.sh (most recent call last):
#     ./test/test_scripts.sh:42  unknown_command
#     ./test/test_scripts.sh:45  bar
#     ./test/test_scripts.sh:48  foo
